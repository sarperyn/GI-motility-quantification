        ...
        for i in range(0,num_samples,1):
            ...
            if n == len(reals)-1:
                ...
                if (opt.mode != "harmonization") & (opt.mode != "editing") & (opt.mode != "SR") & (opt.mode != "paint2image"):
                    ...
                    plt.imsave('%s/%d_mask.png' % (dir2save, i), functions.convert_image_np(I_curr.detach())[:,:,3], vmin=0,vmax=1) # Vajira
                    plt.imsave('%s/%d_img.png' % (dir2save, i), functions.convert_image_np(I_curr.detach())[:,:,0:3], vmin=0,vmax=1) # Vajira
