...
from src.utils.metric_utils import dice_coefficient
...
def train_one_epoch(model, 
    ...
    if epoch+1 % 5 == 0:
        model_save_path = os.path.join(save_path, args.exp_id, 'model', f'model_{epoch}.pt')
...
def get_configs(config_path):
    ...
    return model_class, dataset_class, optimizer_class, optimizer_init_args, scheduler_class, criterion, save_path
